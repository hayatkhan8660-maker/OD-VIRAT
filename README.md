...
<p>The obtained quantitative results in terms of 𝐴<sub>𝑃</sub>, 𝐴𝑃<sub>50</sub>, 𝐴𝑃<sub>75</sub>, 𝐴𝑃<sub>𝑆</sub> , 𝐴𝑃<sub>𝑀</sub>, and 𝐴𝑃𝐿 on test images perturbed with <strong>Gaussian Noise</strong>, <strong>Motion Blur</strong>, <strong>Snow</strong>, and <strong>Elastic Transform</strong> and eight different level of perturbation severity <strong>(i.e., s = [1:1:5])</strong>.</p>
